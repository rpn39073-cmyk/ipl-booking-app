                ...
                <div className="p-5 flex flex-col justify-between flex-grow">
                  <div>
                    ...
                    <div className="text-gray-500 text-sm mt-3 flex items-center space-x-2">
                      ...
                      <span>{new Date(match.date_time).toLocaleDateString('en-IN', { weekday: 'short', day: 'numeric', month: 'short', year: 'numeric', timeZone: 'Asia/Kolkata'})}, {new Date(match.date_time).toLocaleTimeString('en-IN', { hour: '2-digit', minute: '2-digit', hour12: true, timeZone: 'Asia/Kolkata'}).toUpperCase()}</span>
                    </div>
