                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                       <div className="flex items-center text-sm text-gray-600">
                          ...
                          <span>{new Date(match.date_time).toLocaleDateString('en-IN', { timeZone: 'Asia/Kolkata' })} | {new Date(match.date_time).toLocaleTimeString('en-IN', { hour: '2-digit', minute: '2-digit', hour12: true, timeZone: 'Asia/Kolkata' }).toUpperCase()}</span>
                       </div>
                       <div className="flex items-center text-sm text-gray-600">
